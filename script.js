...
const vragen = [
    ...
    {
        vraag: "Hoe heet de persoon die veiligheidsintructies uitlegd voor het vliegtuig opstijgt?",
    ...
    },
    {
        ...
        opties: ["Om geld te wisselen", "Om toegang te krijgen tot het vliegtuig ", "Om bagage te wegen", "Om drankjes te bestellen"],
        correct: 1
    },
    {
        vraag: "Wat voor voertuig rijdt voor het vliegtuig uit om het naar de startbaan te begeleiden?",
        opties: [" Politiewagen ", " Pushback truck (sleepvoertuig)", "Taxi ", "Bus"],
        correct: 1
    },
    {
        vraag: "Hoe noem je het gebouw op het vliegveld waar je incheckt en door de controle gaat? ",
        opties: ["Terminal", " Hangar ", "Startbaan", "Bagageruim "],
        correct: 0
    },
    {
        vraag: "Hoe noemen we de stoelen helemaal voorin het vliegtuig met meer luxe en ruimte? ",
        opties: [" Bagageruimte ", " Cockpit ", "Business class of first class ", "Economy class "],
        correct: 3
    },
    {
        vraag: "Wat doet de steward of stewardess als het vliegtuig turbulentie krijgt?",
        opties: ["Gordel vastmaken en iedereen vragen dit ook te doen", "zelf het vliegtuig besturen", "Gratis eten uitdelen", "Het vliegtuig laten landen"],
        correct: 0
    },
    {
        vraag: "Welke taal wordt bijna altijd gebruikt naast de moedertaal van de luchtvaartmaatschappij?",
        opties: ["Engels", " Spaans", "Mandarijns", "Frans"],
        correct: 0
    },
    {
        vraag: "Wat geeft een piloot vaak door via de intercom tijdens de vlucht?",
        opties: ["Muziek concert", "Informatie over de vlucht", "Recepten", "Reclames"],
        correct: 1
    }, 
       {
        vraag: "Hoe noem je het kleine raam bij je stoel in het vliegtuig?",
        opties: ["Parabrisa", "Raampje / vliegtuigraam", "Ventilatiegat ", "Voorruit"],
        correct: 1
    }, 
       {
        vraag: "Wat staat meestal op de vleugel van het vliegtuig, zodat je het bedrijf herkent?",
        opties: ["Reclames", " Nummerplaten", "Vlag van het land", "Logo of naam van de luchtvaartmaatschappij "],
        correct: 3
    }, 
      {
        vraag: "Hoe noem je de ruimte waar alle koffers onder de passagiersstoelen liggen?",
